...
def g():
    ...
    passenger_url = "https://raw.githubusercontent.com/workinn/public_dump/main/" + surv_text + ".png"
    print("Passenger predicted: " + surv_text)
    ...
    label_url = "https://raw.githubusercontent.com/workinn/public_dump/main/" + surv_text + ".png"
    print("Passenger actual: " + surv_text)
    ...
    if predictions.value_counts().count() == 2:
        ...
        df_cm = pd.DataFrame(results, ['True Dead', 'True Alive'],
